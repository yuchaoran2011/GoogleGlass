...
public class MovingAverageStepDetector extends StepDetector {
	...
	public static final float LOW_POWER_CUTOFF_VALUE = 200.0f;   //2000.0f // 200 for vertical 45 degrees with wall
	...
	private double processAccelerometerValues(long timestamp, float[] values) {
		...
		if (stepDetected) {
			writeToFile("power.txt", System.currentTimeMillis() + " " + maValues[3] + "\n");
			asp.reset();
		}
