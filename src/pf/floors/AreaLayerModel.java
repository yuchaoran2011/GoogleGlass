...
public class AreaLayerModel implements Serializable {
	...
	public void computeBuckets(float gridSize) {
		...
		*/
		...
		//Log.d(TAG, "computeBuckets: hash computation took "+ (System.nanoTime() - start) / Math.pow(10, 9));
		/*
		double avg = 0.0;
	...
	private void setBoundingBox(Rectangle box, Set<Line2D> wallSet) {
		...
		//Log.d(TAG, "wall set has " + wallSet.size() + " items (out of "	+ completeSet.size() + ").");
